                                                ...
                                                <td class="wrapper">
                                                    ...
                                                    <table class="six columns">
                                                        <tr>
                                                            <td>
                                                                <a href="index.html">
                                                                    <img src="../../assets/img/logo/dashboard_header_logo.png"/>
                                                                </a>
                                                            </td>
                                                            <td class="expander">
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="text-right valign-middle">
                                                                <span class="template-label">
                                                                    <?php if(isset($subject) && !empty($subject)){ echo $subject; } ?>
                                                                </span>
                                                            </td>
                                                            <td class="expander">
                                                            </td>
                                            ...
                                            <td class="wrapper">
                                                <table class="twelve columns">
                                                    ...
                                                    <tr>
                                                        <td class="panel">
                                                            <a href="javascript:;">
                                                                <?php if(isset($link_message) && !empty($link_message)) { echo $link_message; } ?>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <tr>
