...
class Ajax_pagination
{
    ...
    public $first_tag_open  = '<li class="paginate_button">';
    public $first_tag_close = '</li>';
    public $last_tag_open   = '<li class="paginate_button">';
    public $last_tag_close  = '</li>';
    public $cur_tag_open    = '<li class="paginate_button active"><a href="#">';
    public $cur_tag_close   = '</a></li>';
    public $next_tag_open   = '<li class="paginate_button">';
    public $next_tag_close  = '</li>';
    public $prev_tag_open   = '<li class="paginate_button">';
    public $prev_tag_close  = '</li>';
    public $num_tag_open    = '<li class="paginate_button">';
    ...
    function getData()
    {
        ?>
            <script>
                ...
                {
                     var formData = new FormData($('<?php echo $this->formdata; ?>')[0]);
